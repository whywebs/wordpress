...
add_action( 'widgets_init', array('Fastnews_Light_Widget_Entry_List_2', 'register_widget'));

class Fastnews_Light_Widget_Entry_List_2 extends Kopa_Widget{

    public static function register_widget(){
        register_widget('Fastnews_Light_Widget_Entry_List_2');
    }

    public function __construct() {
        $this->widget_cssclass = 'kp-entry-list-widget';
        $this->widget_description = esc_attr__('Display Featured Articles Widget', 'fastnews-light-toolkit');
        $this->widget_id = 'fastnews-light-entry-list-2';
        $this->widget_name = esc_attr__('(Fastnews light) Entry List 2', 'fastnews-light-toolkit');
