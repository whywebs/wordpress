		...
		foreach ( $this->settings as $key => $setting ) {
			...
			switch ( $setting['type'] ) {
                ...
                case 'icon': ?>
                    <p>
                        <label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html( $setting['label'] ); ?></label>
                        <a class="kf-icon-picker" href="#"><?php echo esc_html__('Select icon', 'kopa-framework'); ?></a>
                        <input type="hidden"
                               name="<?php echo esc_attr( $this->get_field_name( $key ) ); ?>"
                               id="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"
                               value="<?php echo esc_attr($value);?>"
                               autocomplete="off"
                               class="widefat kf-icon-picker-value"/>
                        <span class="kf-icon-picker-preview"><i class="<?php echo esc_attr($value);?>"></i></span>
                    </p>
                    <?php break;
			}
