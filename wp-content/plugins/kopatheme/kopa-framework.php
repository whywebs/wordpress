...
final class Kopa_Framework {
    ...
    public function meta_box_wrap_start($wrap, $value, $loop_index){
        if(0 == $loop_index){
            $wrap = '<div class="kopa-metabox-wrap kopa-metabox-wrap-first kf-row">';
        }else{
            $wrap = '<div class="kopa-metabox-wrap kf-row">';
        }

        if ( $value['title'] ) {
            $wrap .= '<div class="kf-col-xs-3">';
            $wrap .= esc_html($value['title']);
            $wrap .= '</div>';
            $wrap .= '<div class="kf-col-xs-9">';
        }else{
            $wrap .= '<div class="kf-col-xs-12">';
        }
