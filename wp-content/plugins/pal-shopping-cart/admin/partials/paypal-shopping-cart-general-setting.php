...
class Paypal_Shopping_Cart_General_Setting {
    ...
    public static function paypal_shopping_cart_psc_setting_general_tab_setting_fields() {
        ...
        $fields[] = array(
            'title' => __('Redirect page', 'pal-shopping-cart'),
            'id' => 'psc_addtocart_after_general_settings',
            'type' => 'select',
            'css' => 'width:25em;',
            'desc' => 'Add ot cart after redirect page.',
        ...
        $fields[] = array(
            ...
            'type' => 'checkbox',
            'desc' => 'Enable the use of coupons in cart',
            'default' => 'yes'
        );
    ...
    public static function paypal_shopping_cart_psc_setting_product_tab_setting_fields() {
        ...
        $fields[] = array(
            'title' => __('Nuber of Column', 'pal-shopping-cart'),
...
Store Admin";
    ...
    public static function paypal_shopping_cart_psc_setting_checkout_tab_setting_fields() {
        ...
        $fields[] = array(
            ...
            'css' => '',
            'type' => 'checkbox',
            'desc' => __('Enable this gateway', 'pal-shopping-cart'),
            'default' => 'no'
        );
        ...
        $fields[] = array(
            'title' => __('PayPal Sandbox', 'pal-shopping-cart'),
            'id' => 'psc_pec_testmode',
            'type' => 'checkbox',
            'label' => __('Enable Sandbox', 'pal-shopping-cart'),
            'default' => 'no',
        ...
        $fields[] = array(
            'title' => __('Sandbox API User Name', 'pal-shopping-cart'),
        ...
        $fields[] = array(
            'title' => __('Sandbox API Password', 'pal-shopping-cart'),
        ...
        $fields[] = array(
            'title' => __('Sandbox API Signature', 'pal-shopping-cart'),
        ...
        $fields[] = array(
            'title' => __('Live API User Name', 'pal-shopping-cart'),
        ...
        $fields[] = array(
            'title' => __('Live API Password', 'pal-shopping-cart'),
        ...
        $fields[] = array(
            'title' => __('Live API Signature', 'pal-shopping-cart'),
        ...
        $fields[] = array(
            'title' => __('Invoice ID Prefix', 'pal-shopping-cart'),
