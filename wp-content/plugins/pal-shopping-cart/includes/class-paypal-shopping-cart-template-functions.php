...
if (!function_exists('psc_output_content_wrapper')) {

    function psc_output_content_wrapper() {
        psc_get_template('global/psc-wrapper-start.php');
    }

}

if (!function_exists('psc_output_content_wrapper_end')) {

    function psc_output_content_wrapper_end() {
        psc_get_template('global/psc-wrapper-end.php');
    }
...
if (!function_exists('placeholder_img')) {
    function placeholder_img($size = 'psc_shop_thumbnail') {
        ...
        return apply_filters('psc_placeholder_img', '<img src="' . placeholder_img_src() . '" alt="' . esc_attr__('Placeholder', 'pal-shopping-cart') . '" width="' . esc_attr($dimensions['width']) . '" class="psc-placeholder wp-post-image" height="' . esc_attr($dimensions['height']) . '" />', $size, $dimensions);
    }
}
