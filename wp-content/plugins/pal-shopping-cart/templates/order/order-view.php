...
$TRANSACTIONID = ($get_order_all_details[1][0]['TRANSACTIONID']) ? $get_order_all_details[1][0]['TRANSACTIONID'] : '';
$PAYMENT_METHOD_TITLE = ($get_order_all_details[0]['_payment_method_title']) ? $get_order_all_details[0]['_payment_method_title'] : '';
?>
<div id="order_view" class="panel">
    ...
    <div class="pscorder_data_column_container">
        <div class="order_data_column">
            ...
            <h4 class="address_header">Billing Details Address:</h4>
            <p>
                <?php
        ...
        <div class="order_data_column">
            ...
            <h4 class="address_header">Shipping Details Address:</h4>
            <p>
                <?php
