...
= 1.6.9 =
* Fixed: Exporting Custom Fields containing arrays

= 1.6.8 =
* Fixed: Incorrect WordPress security token check
* Added: %random% Tag to export filename
...
= 1.6.5 =
* Fixed: Custom Fields not exporting
