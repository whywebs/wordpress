...
if( is_admin() ) {
	...
	function wpsc_st_add_modules_admin_pages( $page_hooks, $base_page ) {
		...
		$page_hooks[] = add_submenu_page( $base_page, __( 'Store Toolkit', 'wp-e-commerce-store-toolkit' ), __( 'Store Toolkit', 'wp-e-commerce-store-toolkit' ), 'manage_options', 'wpsc_st', 'wpsc_st_html_toolkit' );
		return $page_hooks;
