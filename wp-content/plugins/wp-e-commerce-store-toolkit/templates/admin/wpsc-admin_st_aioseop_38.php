<p class="description"><?php _e( 'Use this form to enter All in One SEO Pack details for this Product.', 'wp-e-commerce-store-toolkit' ); ?></p>
<table>

	<tr>
		<td scope="row" style="padding:0 0 0.5em 0;">
			<label for="wpsc_st_aioseop_title"><?php _e( 'Title', 'wp-e-commerce-store-toolkit' ); ?>:</label>
		</td>
		<td>
	...
	<tr>
		<td scope="row" style="padding:0 0 0.25em 0;">
			<label for="wpsc_st_aioseop_description"><?php _e( 'Description', 'wp-e-commerce-store-toolkit' ); ?>:</label>
		</td>
		<td>
	...
	<tr>
		<td scope="row" style="padding:0 0 0.25em 0;">
			<label for="wpsc_st_aioseop_keywords"><?php _e( 'Keywords (comma separated)', 'wp-e-commerce-store-toolkit' ); ?>:</label>
		</td>
		<td>
	...
	<tr>
		<td scope="row" style="padding:0 0 0.25em 0;">
			<label for="wpsc_st_aioseop_title_atr"><?php _e( 'Title atrributes', 'wp-e-commerce-store-toolkit' ); ?>:</label>
		</td>
		<td>
	...
	<tr>
		<td scope="row" style="padding:0 0 0.25em 0;">
			<label for="wpsc_st_aioseop_menu_label"><?php _e( 'Menu label', 'wp-e-commerce-store-toolkit' ); ?>:</label>
		</td>
		<td>
